	...
	stages{
		...
		stage('invoke playbook'){
      			steps{
                           ...
                           withCredentials([
                    string(credentialsId: 'vaultID1', variable: 'VAULT_PASS'),
   	...
   	ansiblePlaybook become: true, credentialsId: 'UbuntuID1', installation: 'A1', inventory: '/etc/ansible/env', playbook: './app_playbook.yml', vaultCredentialsId: 'vaultID1', vaultTmpPath: '' , extraVars: [  ansible_become_pass: "${BECOME_PASS}" ]
           	}
	}
   }
}
