pipeline{
	...
	stages{
   	...
   	sudo ansiblePlaybook become: true, credentialsId: 'UbuntuID1', installation: 'A1', inventory: '/etc/ansible/env', playbook: './app_playbook.yml', vaultCredentialsId: 'vaultID1', vaultTmpPath: ''
           	}
	}
   }
}
